...
Version `v1.7.7-1-5m-ops-observability-20260627` refuses to start the scanner worker if these values are missing or placeholder-like:
...
Version `v1.7.7-1-5m-ops-observability-20260627` also adds `/ops/readiness`, which shows whether the API, scanner heartbeat, and TON payment range are ready for real testing.
